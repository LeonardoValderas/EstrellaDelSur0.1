...
public class Entrenamiento {
   //ENTRENAMIENTO
    ...
    public void setUSUARIO_ACTUALIZACION(String USUARIO_ACTUALIZACION) {this.USUARIO_ACTUALIZACION = USUARIO_ACTUALIZACION;}
    ...
    public void setUSUARIO_CREADOR(String USUARIO_CREADOR) {this.USUARIO_CREADOR = USUARIO_CREADOR;}
    ...
    public void setDIA(String dIA) {DIA = dIA;}
