...
public class Entrenamiento_Division {
	...
	public Entrenamiento_Division(int entrenamiento_division, int id_entrenamiento,int id_division,String descricpion, boolean isSelected) {
