package com.estrelladelsur.estrelladelsur.institucion.tabs_adm;
...
public class TabsArticulo extends AppCompatActivity implements CommunicatorAdeful {
...
//        titulos = auxiliarGeneral.tituloFont(TabsArticulo.this);
    ...
    public class TabsArticuloAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    fragmentTab = FragmentGenerarArticuloAdeful.newInstance();

                    break;
                case 1:
                    fragmentTab = FragmentEditarArticuloAdeful.newInstance();
    ...
    public void refreshAdeful() {
        ...
        FragmentEditarArticuloAdeful fragment = (FragmentEditarArticuloAdeful) manager
