...
import com.estrelladelsur.estrelladelsur.social.administrador.FragmentEditarNoticia;
import com.estrelladelsur.estrelladelsur.social.administrador.FragmentGenerarNoticia;

public class TabsNoticia extends AppCompatActivity implements Communicator {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            viewPager.setAdapter(new TabsNoticiaAdapter(
    ...
    public class TabsNoticiaAdapter extends FragmentPagerAdapter {

        private FragmentManager fm;
        private String tabTitles[] =
                new String[]{"CREAR NOTICIA", "EDITAR NOTICIA"};

        public TabsNoticiaAdapter(FragmentManager fm) {
            super(fm);
            this.fm = fm;
        }
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    fragmentTab = FragmentGenerarNoticia.newInstance();

                    break;
                case 1:
                    fragmentTab = FragmentEditarNoticia.newInstance();
    ...
    public void refresh() {
        ...
        FragmentEditarNoticia fragment = (FragmentEditarNoticia) manager
                .findFragmentByTag("android:switcher:" + viewPager.getId()
                        + ":" + 1);
        fragment.recyclerViewLoadNoticia();
    }
}
