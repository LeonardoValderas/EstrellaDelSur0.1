...
public class SQLiteDBConnectionGeneral extends SQLiteOpenHelper {
    ...
    //MODULOS
    String TABLA_MODULO = "CREATE TABLE IF NOT EXISTS MODULO (ID_MODULO INTEGER PRIMARY KEY AUTOINCREMENT,"
            + " NOMBRE VARCHAR(200));";
    //SUBMODULOS
    String TABLA_SUBMODULO = "CREATE TABLE IF NOT EXISTS SUBMODULO (ID_SUBMODULO INTEGER PRIMARY KEY AUTOINCREMENT,"
            + " NOMBRE VARCHAR(200), "
            + " ID_MODULO INTEGER,"
            + " ISSELECTED BOOLEAN,"
            + " FOREIGN KEY(ID_MODULO) REFERENCES MODULO_ADEFUL(ID_MODULO));";
    //USUARIOS
    String TABLA_USUARIO = "CREATE TABLE IF NOT EXISTS USUARIO (ID_USUARIO INTEGER PRIMARY KEY AUTOINCREMENT,"
            + " USUARIO VARCHAR(200),"
    ...
    //NOTIFICACION
    String TABLA_NOTIFICACION = "CREATE TABLE IF NOT EXISTS NOTIFICACION (ID_NOTIFICACION INTEGER PRIMARY KEY AUTOINCREMENT,"
            + " TITULO VARCHAR(200),"
            ...
            + " FECHA_ACTUALIZACION VARCHAR(100));";
    //NOTICIA
    String TABLA_NOTICIA = "CREATE TABLE IF NOT EXISTS NOTICIA (ID_NOTICIA INTEGER PRIMARY KEY AUTOINCREMENT,"
            + " TITULO VARCHAR(200),"
    ...
    //FOTO
    String TABLA_FOTO = "CREATE TABLE IF NOT EXISTS FOTO (ID_FOTO INTEGER PRIMARY KEY AUTOINCREMENT,"
            + " TITULO VARCHAR(200),"
            + " FOTO BLOB,"
            + " USUARIO_CREADOR VARCHAR(100),"
            + " FECHA_CREACION VARCHAR(100),"
    ...
    //PUBLICIDAD
    String TABLA_PUBLICIDAD = "CREATE TABLE IF NOT EXISTS PUBLICIDAD (ID_PUBLICIDAD INTEGER PRIMARY KEY AUTOINCREMENT,"
            + " TITULO VARCHAR(200),"
            + " LOGO BLOB,"
            + " OTROS VARCHAR(200),"
            + " USUARIO_CREADOR VARCHAR(100),"
