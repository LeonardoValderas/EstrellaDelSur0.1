...
public class FragmentGenerarResultadoAdeful extends Fragment implements MyAsyncTaskListener {
    ...
    public static FragmentGenerarResultadoAdeful newInstance() {
        FragmentGenerarResultadoAdeful fragment = new FragmentGenerarResultadoAdeful();
        return fragment;
    }

    public FragmentGenerarResultadoAdeful() {
...
//			Intent usuario = new Intent(ActivityResultadoAdeful.this,
