...
import com.estrelladelsur.estrelladelsur.miequipo.general.FragmentAsistencia;
import com.estrelladelsur.estrelladelsur.miequipo.general.FragmentEditarEntrenamiento;
import com.estrelladelsur.estrelladelsur.miequipo.general.FragmentGenerarEntrenamiento;
import com.estrelladelsur.estrelladelsur.miequipo.usuario.FragmentEntrenamientoUsuario;

public class TabsEntrenamientoUsuario extends AppCompatActivity {
    ...
    public class TabsEntrenamientoAdapter extends FragmentPagerAdapter {
        ...
        private String tabTitles[] = new String[]{"ENTRENAMIENTO",
                "ASISTENCIA"};
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    fragmentTab = FragmentEntrenamientoUsuario.newInstance();
                    break;
                case 1:
                    fragmentTab = FragmentEntrenamientoUsuario.newInstance();
                    break;
