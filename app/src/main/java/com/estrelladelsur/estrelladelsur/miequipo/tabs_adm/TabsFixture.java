package com.estrelladelsur.estrelladelsur.miequipo.tabs_adm;
...
import com.estrelladelsur.estrelladelsur.miequipo.adeful.FragmentEditarFixtureAdeful;
import com.estrelladelsur.estrelladelsur.miequipo.adeful.FragmentGenerarFixtureAdeful;
import com.estrelladelsur.estrelladelsur.miequipo.lifuba.FragmentEditarFixtureLifuba;
import com.estrelladelsur.estrelladelsur.miequipo.lifuba.FragmentGenerarFixtureLifuba;
...
public class TabsFixture extends AppCompatActivity {
    ...
    public class TabsFixtureAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    fragmentTab = FragmentGenerarFixtureAdeful.newInstance();
                    break;
                case 1:
                    fragmentTab = FragmentEditarFixtureAdeful.newInstance();
                    break;
                case 2:
                    fragmentTab = FragmentGenerarFixtureLifuba.newInstance();
                    break;
                case 3:
                    fragmentTab = FragmentEditarFixtureLifuba.newInstance();
                    break;
            }
            return fragmentTab;
        }
