...
public class AdaptadorRecyclerEquipoUsuario extends
		RecyclerView.Adapter<AdaptadorRecyclerEquipoUsuario.EquipoAdefulViewHolder> implements
	...
	public AdaptadorRecyclerEquipoUsuario(ArrayList<Equipo> datosEquipoArray, Context context) {
