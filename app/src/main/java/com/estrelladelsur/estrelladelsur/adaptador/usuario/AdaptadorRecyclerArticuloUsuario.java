...
public class AdaptadorRecyclerArticuloUsuario extends
        RecyclerView.Adapter<AdaptadorRecyclerArticuloUsuario.ArticuloViewHolder> implements
    ...
    public AdaptadorRecyclerArticuloUsuario(ArrayList<Articulo> articuloArray, Context context) {
