...
public class AdapterSpinnerJugador extends ArrayAdapter<JugadorRecycler>
    {
        private Activity context;
        ArrayList<JugadorRecycler> jugadorArray = null;

        public AdapterSpinnerJugador(Activity context, int resource, ArrayList<JugadorRecycler> jugadorArray)
        {
        ...
        {   // This view starts when we click the spinner.
            ...
            JugadorRecycler  jugadorRecycler = jugadorArray.get(position);
